...
import static uk.ac.herc.iminds.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import uk.ac.herc.iminds.config.Constants;
import uk.ac.herc.iminds.domain.User;
import uk.ac.herc.iminds.repository.AuthorityRepository;
import uk.ac.herc.iminds.repository.UserRepository;
import uk.ac.herc.iminds.security.AuthoritiesConstants;
import uk.ac.herc.iminds.service.UserService;
import uk.ac.herc.iminds.service.dto.AdminUserDTO;
import uk.ac.herc.iminds.service.dto.PasswordChangeDTO;
import uk.ac.herc.iminds.service.dto.UserDTO;
import uk.ac.herc.iminds.web.rest.vm.KeyAndPasswordVM;
import uk.ac.herc.iminds.web.rest.vm.ManagedUserVM;
