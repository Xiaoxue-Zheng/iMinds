...
Story: View participants
    Scenario: View participant summary
        ...
        And: For each participant the view shall include participant id, unique code and a link (e.g. button) that opens a separate screen to view data

    Scenario: View participant details
        Given: The participant is viewing the participant summary page
